...
function chooseAnimal(animal) {
  ...
  if (animal == "cat") {
    document.querySelector(".modal-shop .title-text").innerHTML = "КОТ";
  } else if (animal == "korgi") {
    document.querySelector(".modal-shop .title-text").innerHTML = "КОРГИ";
  } else if (animal == "panda") {
    document.querySelector(".modal-shop .title-text").innerHTML = "ПАНДА";
  } else if (animal == "red_panda") {
    document.querySelector(".modal-shop .title-text").innerHTML = "КРАСНАЯ ПАНДА";
  } else if (animal == "koala") {
    document.querySelector(".modal-shop .title-text").innerHTML = "КОАЛА";
  } else if (animal == "sloth") {
    document.querySelector(".modal-shop .title-text").innerHTML = "ЛЕНИВЕЦ";
  }
...
function chooseUpgrade(upgrade) {
  ...
  if (upgrade == "cursor") {
    document.querySelector(".modal-upgrade .title-text").innerHTML = "КУРСОР";
  } else if (upgrade == "box") {
    document.querySelector(".modal-upgrade .title-text").innerHTML = "КОРОБКА";
  } else if (upgrade == "container") {
    document.querySelector(".modal-upgrade .title-text").innerHTML = "КОНТЕЙНЕР";
  } else if (upgrade == "railway_carriage") {
    document.querySelector(".modal-upgrade .title-text").innerHTML = "ВАГОН";
  } else if (upgrade == "ship") {
    document.querySelector(".modal-upgrade .title-text").innerHTML = "КОНТЕЙНЕРОВОЗ";
  } else if (upgrade == "warehouse") {
    document.querySelector(".modal-upgrade .title-text").innerHTML = "СКЛАД";
  } else if (upgrade == "crown") {
    document.querySelector(".modal-upgrade .title-text").innerHTML = "КОРОНА";
  }
  document.querySelector(".score").classList.add("two");
